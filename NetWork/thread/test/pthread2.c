/*
 *      哲学家就餐问题:五个哲学家共用一张圆桌，分别坐在周围的五张椅子上，在圆桌上有五个碗和五只筷子，他们的
 *  生活方式是交替的进行思考和进餐。平时，一个哲学家进行思考，饥饿时便试图取用其左右最靠近他的筷子，只有在他
 *  拿到两只筷子时才能进餐。进餐完毕，放下筷子继续思考。
 *      设计一个程序五个哲学家共用一张圆桌，分别坐在周围的五张椅子上，在圆桌上有五个碗和五只筷子，他们的生活
 *  方式是交替的进行思考和进餐。平时，一个哲学家进行思考，饥饿时便试图取用其左右最靠近他的筷子，只有在他拿到
 *  两只筷子时才能进餐。进餐完毕，放下筷子继续思考。
 *      下面为此问题的一种代码实现，请根据自己的理解写出代码中的思路，以注释的形式加在每步
 * */
#include <stdio.h>
#include <stdlib.h>
#include <memory.h>
